...
# 2023-09-17 [Sen Wang]: brew installation is hard-coded to /app to avoid any
# diretory conflict when using in HPC environment. Line 117
# 2023-09-20 [Sen Wang]: Reversed back to original path /home. If not, some
# packages need to be re-compiled and can cause error from time to time
...
# Initiating homebrew for active user
# Added ad hoc; should replace with variables insteaded of hard-coded values
echo "Installing post-brew-installation requirements\n"

(echo; echo 'eval "$(/home/linuxbrew/.linuxbrew/bin/brew shellenv)"') >> /home/${USER}/.bashrc
eval "$(/home/linuxbrew/.linuxbrew/bin/brew shellenv)"

# Add compatibility with cmake
echo 'export CMAKE_PREFIX_PATH=/home/linuxbrew/.linuxbrew' >> /home/${USER}/.bashrc
