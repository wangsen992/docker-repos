...
TARGET_IMAGE=mpich33_openfoam8
...
docker build -t $DOCKER_ACCOUNT/$TARGET_IMAGE:build \
...
docker build -t $DOCKER_ACCOUNT/mpich33_openfoam8_weno:latest \
			$DOCKER_DIR/Apps/mpich33_openfoam8_weno -f $DOCKER_DIR/Apps/mpich33_openfoam8_weno/Dockerfile
